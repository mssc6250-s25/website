...
subtitle: "Due Friday, Mar 1 11:59 PM"
editor: source
...
(@) **[Special Case for Ridge and Lasso]** Suppose for a linear regression problem with $n = p$, ${\bf X} = {\bf I}$ and no intercept. Show that
    ...
    (b) The ridge estimator is $\hat{\beta}_j^r = \frac{y_j}{1+\lambda} = \underset{\beta_j}{\arg\min} \sum_{j=1}^p\left(y_j - \beta_j\right)^2 + \lambda \sum_{j=1}^p \beta_j^2$.
