...
$$\var(\textbf{b}) = \var\left[{\bf (X'X)}^{-1} {\bf X}' {\bf y} \right] = \sigma^2 {\bf (X'X)}^{-1}$$
...
- For numerical stability, introduce a step size $\delta > 0$:
